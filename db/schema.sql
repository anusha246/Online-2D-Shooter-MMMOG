...
INSERT INTO ftduser VALUES('user1', sha512('password1'), 'user1@example1.com', 'user1name', 'someLastName');
INSERT INTO ftduser VALUES('user2', sha512('password2'), 'user2@example2.com', 'user2name', 'anotherLastName');
